...
def change_password():
    # get user's old password, new password, and confirmed new password from request body
    ...
    if new_password != confirm_new_password:
        return jsonify({'error': 'New password and confirmed new password do not match'})
...
def contact_us():
    # get user's name, email, and message from request body
