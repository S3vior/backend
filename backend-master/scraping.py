...
from models import SourcePage, Base
app = Flask(__name__)
...
def cricgfg():
	...
	sect = soup.find_all('div', class_='swiper-wrapper')

	section = sect[0]
	description = section.find('img', class_='slid_img mx-auto p-md-3 p-2 d-flex align-items-center justify-content-center')
